...
def select_series_title_with_most_human_characters
  "SELECT series.title, COUNT(characters.species = 'human') FROM series INNER JOIN characters ON characters.series_id = series.id
  GROUP BY series.title ORDER BY COUNT(characters.species = 'human')
